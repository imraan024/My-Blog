...
#from . import views
from .views import AddPost, ArticleView, EditorHomeView, HomeView, UpdateArticleView, DeleteArticleView, CreateCat, CategoryView
urlpatterns = [
    ...
    path('view_articles/', EditorHomeView, name="Editor-home"),
]